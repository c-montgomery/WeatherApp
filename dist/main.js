...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html{\n    background: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n    display: grid;\n    justify-content: center;\n    background-size: cover;\n    height: 100%;\n    font-family: 'Nunito', sans-serif;\n}\ninput{\n    margin-top: 20px;\n    border: none;\n    border-radius: 10px;\n    height: 30px;\n    width: 400px;\n}\n.fade{\n    visibility: hidden;\n    opacity: 0;\n    transition: visibility 0s .2s, opacity .2s ease-out;  \n}\n.window{\n    color: white;\n    display: grid;\n    \n    border-radius: 10px;\n    width: 400px;\n    height: 400px;\n    box-shadow: inset 0 0 2000px rgba(18, 17, 17, 0.5);\n   \n   \n  \n}\n.windowHeader{\n    display: grid;\n    grid-template-columns: repeat(3,1fr);\n    grid-template-rows: repeat(2,1fr);\n    border: rgb(97, 219, 162) solid 3px;\n    backdrop-filter: blur(10px);\n    justify-content: center;\n    background-color: rgba(0, 0, 0, 0.742);\n    \n}\n.windowBody{\n    border: green solid 3px \n}\n.headerRight{\n    display: grid;\n    grid-template-rows: 1fr, 3fr, 1fr;\n    grid-column: 3/4;\n    grid-row:1fr;\n    border: 2px solid;\n    text-align: center;\n    line-height: 25px;\n    font-size: 55px;\n}\n.headerRightTop{\n    font-size: 25px;\n    line-height:24px;\n}\n\n.headerRightMiddle img{\n    padding: 15px;\n}\n.headerRightMiddle p{\n    margin-top: 0px;\n    margin-bottom: 22px;\n}\n\n.headerRightMiddle{\n    grid-row: 2/4;\n}\n\n\n.headerRightBottom{\n    grid-row: 4/5;\n    font-size:16px;\n}\n\n.headerLeft{\n    padding: 10px 20px;\n    font-family: 'Bebas Neue', cursive;\n    font-size: 45px;\n    grid-column: 1/3;\n    \n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AACA;IACI,mDAAmC;IACnC,aAAa;IACb,uBAAuB;IACvB,sBAAsB;IACtB,YAAY;IACZ,iCAAiC;AACrC;AACA;IACI,gBAAgB;IAChB,YAAY;IACZ,mBAAmB;IACnB,YAAY;IACZ,YAAY;AAChB;AACA;IACI,kBAAkB;IAClB,UAAU;IACV,mDAAmD;AACvD;AACA;IACI,YAAY;IACZ,aAAa;;IAEb,mBAAmB;IACnB,YAAY;IACZ,aAAa;IACb,kDAAkD;;;;AAItD;AACA;IACI,aAAa;IACb,oCAAoC;IACpC,iCAAiC;IACjC,mCAAmC;IACnC,2BAA2B;IAC3B,uBAAuB;IACvB,sCAAsC;;AAE1C;AACA;IACI;AACJ;AACA;IACI,aAAa;IACb,iCAAiC;IACjC,gBAAgB;IAChB,YAAY;IACZ,iBAAiB;IACjB,kBAAkB;IAClB,iBAAiB;IACjB,eAAe;AACnB;AACA;IACI,eAAe;IACf,gBAAgB;AACpB;;AAEA;IACI,aAAa;AACjB;AACA;IACI,eAAe;IACf,mBAAmB;AACvB;;AAEA;IACI,aAAa;AACjB;;;AAGA;IACI,aAAa;IACb,cAAc;AAClB;;AAEA;IACI,kBAAkB;IAClB,kCAAkC;IAClC,eAAe;IACf,gBAAgB;;AAEpB","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Nunito:wght@600&display=swap');\nhtml{\n    background: url('./background.jpg');\n    display: grid;\n    justify-content: center;\n    background-size: cover;\n    height: 100%;\n    font-family: 'Nunito', sans-serif;\n}\ninput{\n    margin-top: 20px;\n    border: none;\n    border-radius: 10px;\n    height: 30px;\n    width: 400px;\n}\n.fade{\n    visibility: hidden;\n    opacity: 0;\n    transition: visibility 0s .2s, opacity .2s ease-out;  \n}\n.window{\n    color: white;\n    display: grid;\n    \n    border-radius: 10px;\n    width: 400px;\n    height: 400px;\n    box-shadow: inset 0 0 2000px rgba(18, 17, 17, 0.5);\n   \n   \n  \n}\n.windowHeader{\n    display: grid;\n    grid-template-columns: repeat(3,1fr);\n    grid-template-rows: repeat(2,1fr);\n    border: rgb(97, 219, 162) solid 3px;\n    backdrop-filter: blur(10px);\n    justify-content: center;\n    background-color: rgba(0, 0, 0, 0.742);\n    \n}\n.windowBody{\n    border: green solid 3px \n}\n.headerRight{\n    display: grid;\n    grid-template-rows: 1fr, 3fr, 1fr;\n    grid-column: 3/4;\n    grid-row:1fr;\n    border: 2px solid;\n    text-align: center;\n    line-height: 25px;\n    font-size: 55px;\n}\n.headerRightTop{\n    font-size: 25px;\n    line-height:24px;\n}\n\n.headerRightMiddle img{\n    padding: 15px;\n}\n.headerRightMiddle p{\n    margin-top: 0px;\n    margin-bottom: 22px;\n}\n\n.headerRightMiddle{\n    grid-row: 2/4;\n}\n\n\n.headerRightBottom{\n    grid-row: 4/5;\n    font-size:16px;\n}\n\n.headerLeft{\n    padding: 10px 20px;\n    font-family: 'Bebas Neue', cursive;\n    font-size: 45px;\n    grid-column: 1/3;\n    \n}"],"sourceRoot":""}]);
// Exports
